        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Major = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TypeOfRoles = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Card", x => new { x.UserId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "50a53b05-5a88-4736-b340-575c3b9b9431", null, "Shop", "SHOP" },
                    { "5dcdf310-ac9d-4d57-a7c1-0054d73c78ed", null, "User", "USER" },
                    { "b4b420a4-b232-4fd1-b396-82444e6419cf", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "cars.png", "Cars" },
                    { 2, "Electronic.png", "Electronic" },
                    { 3, "home.png", "Home" },
                    { 4, "Baby.png", "Baby_Kids" },
                    { 5, "Beauty.png", "Beauty" },
                    { 6, "Clothes.png", "Clothes" },
                    { 7, "Bags.png", "Bags" },
                    { 8, "Books.png", "Books" },
                    { 9, "Health.png", "Health_and_Personal_Care" },
                    { 10, "Jewelry.png", "Jewelry" },
                    { 11, "pets.png", "pets" },
                    { 12, "Sport.png", "Sport_Fitness" }
                });
